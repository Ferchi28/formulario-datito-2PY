...
#Validaciones ,nos encanta el inglish 
def isValidInt(val):
    try:
      int(val)
      return True
...
btnClear = tk.Button(window, text = "Limpiar", command=clear)
btnClear.pack()
btnSave  = tk.Button(window, text = "Guardar", command=save)
btnSave.pack()
